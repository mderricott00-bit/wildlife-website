        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              ...
              <a href="#" className="p-2 rounded-lg hover:bg-primary/10 transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5 text-foreground/70" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="p-2 rounded-lg hover:bg-primary/10 transition-colors" aria-label="Twitter">
                <svg className="w-5 h-5 text-foreground/70" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/wildlife" className="text-foreground/70 hover:text-primary transition-colors">
                  Wildlife Rescue
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/subscribe" className="text-foreground/70 hover:text-primary transition-colors">
                  Subscribe
                </Link>
              </li>
            </ul>
          ...
          {/* Opening Hours */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-foreground">Opening Hours</h3>
            <ul className="space-y-2 text-sm text-foreground/70">
              ...
              <li className="pt-2 border-t border-border">
                <span className="text-xs">Wildlife Centre tours by appointment</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <Link href="/accessibility" className="text-foreground/70 hover:text-primary transition-colors">
                Accessibility
              </Link>
            </div>
          </div>
